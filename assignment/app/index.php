        ...
        <div class="container-fluid" id="fixed_navbar">
            ...
            <div class="collapse navbar-collapse">   
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" title="Josephine de Haan--Montes" onclick="openModalClicked()">Contact</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item collapsible_nav_item" href="#" onClick="switchModelView('costa');">Costa</a>
                            ...
                            <a class="dropdown-item collapsible_nav_item" href="#" onClick="switchModelView('powerade');">Powerade</a>
                        </div>
                    </li>
                    <li class="nav-item">
    ...
    <div id="home" class="container-fluid main_contents">
        ...
        <div class="col-sm-1"></div>
            ...
            <div class="col-sm-2">
                ...
                <div class="card borderless">
                    <a href="#" class="home_card_img">
                        <img id="poweradeCardImage" class="img-fluid" alt="powerade logo">
                    </a>
                    <div class="card-body">
                        <div class="card-title" id="poweradeCardTitle"></div>
                        <div class="card-text" id="poweradeCardDescription"></div>
                        <a id="poweradeCardLink" href="#" class="btn btn-sm btn-outline-primary">Find out more...</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-2">
                <div class="card borderless">
                    <a href="#" class="home_card_img">
                        <img id="costaCardImage" class="img-fluid" alt="costa logo">
                    </a>
                    <div class="card-body">
                        <div class="card-title" id="costaCardTitle"></div>
                        <div class="card-text" id="costaCardDescription"></div>
                        <a id="costaCardLink" href="#" class="btn btn-sm btn-outline-primary">Find out more...</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-1"></div>
            ...
            <div class="col-sm-8">
                <div class="card text-left" id="viewer_3d">
                    ...
                    <div class="card gallery">
                        ...
                        <a onClick="switchModelView('cola');">
                        <img class="card-img-top gallery img-thumbnail" src="assets/images/cards/coke_square_576.png"/></a>

</div>

                        <div class="cardDiv">
                        <a  onClick="switchModelView('costa');" >

                        <img class="card-img-top gallery img-thumbnail" src="assets/images/cards/costa_square_576.png"/></a>
                        ...
                        <div class="cardDiv">
                        <a onclick="switchModelView('sprite');" >

                        <img class="card-img-top gallery img-thumbnail" src="assets/images/cards/sprite_square_576.png"/></a>

</div>


                        <div class="cardDiv">
                        <a onClick="switchModelView('pepper');">
                        <img class="card-img-top gallery img-thumbnail" src="assets/images/cards/pepper_square_576.png"/></a>

</div>


<div class="cardDiv">
                        <a onClick="switchModelView('powerade');">
                        <img class="card-img-top gallery img-thumbnail" src="assets/images/cards/powerade_square_576.png"/></a>
